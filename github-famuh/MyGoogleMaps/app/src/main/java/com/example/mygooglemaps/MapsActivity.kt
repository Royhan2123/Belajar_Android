...
//        mMap.moveCamera(CameraUpdateFactory.newLatLng(sydney))
        ...
        // marker sesuai POI / point of interest
        mMap.setOnPoiClickListener { poinOfInterest ->
            val poiMarker = mMap.addMarker(
                MarkerOptions()
                    .position(poinOfInterest.latLng)
                    .title(poinOfInterest.name)
                    .icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_MAGENTA))
            )
            poiMarker?.showInfoWindow()
        }

//        // marker sesuai dgn lokasi yg dipilih (bebas)
...
//    }
    ...
    private fun addManyMarker() {
        ...
        tourismPlace.forEach { tourismPlace ->
