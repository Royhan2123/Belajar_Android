...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    /*
    Bila Anda memiliki peranti Android dengan versi Marshmallow ke atas,
    Anda perlu memberikan permission pada aplikasi untuk mengirimkan SMS.
     Jadi kita perlu menambahkan kelas untuk mengatur permission.
     */
