...
class FormUserPreferenceActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // kode untuk mengambil data dari Intent
    ...
    //  kode agar FormUserPreferenceActivity bisa kembali ke MainActivity
    ...
    // kode untuk mengubah data hasil dari intent ke View-nya
