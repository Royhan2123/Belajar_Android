...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun startOneTimeTask() {
        ...
        /*mengatur kapan task dieksekusi, misal saat ada koneksi internet,
        saat sedang diisi dayanya, maupun saat memori tidak penuh, dll menggunakan constraint.
         */
    ...
    private fun startPeriodicTask() {
        ...
        // mengatur periodic setiap 15 mnt
