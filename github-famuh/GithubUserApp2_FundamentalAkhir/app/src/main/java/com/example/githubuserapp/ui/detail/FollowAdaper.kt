...
class FollowAdapter(private val context: Context, private val follows: ArrayList<FollowItem>) :
    RecyclerView.Adapter<FollowAdapter.ListViewHolder>() {

    class ListViewHolder(val binding: ItemUserFollowsBinding) :
    ...
    fun setListUser(foll: ArrayList<FollowItem>) {
        follows.clear()
        follows.addAll(foll)
